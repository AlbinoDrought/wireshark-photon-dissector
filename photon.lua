...
-- connections
local pf_conn_data = ProtoField.bytes("photon.command.conn_data", "Data")

-- connection verifications
local pf_connverify_data = ProtoField.bytes("photon.command.connverify_data", "Data")
...
local pf_command_msg_parameters = ProtoField.bytes("photon.command.message.parameters", "Parameters")
